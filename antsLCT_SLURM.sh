...
#rsync -v -a --prune-empty-dirs --include '*/' --include '*T1w.nii.gz' --exclude '*' /winmounts/uqtshaw/data.cai.uq.edu.au/STIMMRI20-Q1876/data/bids/ ./STIMMRI/
export ITK_GLOBAL_DEFAULT_NUMBER_OF_THREADS=8
subjName=$1
#singularity="singularity exec --bind /30days:/30days/ /home/uqtshaw/ants_2.3.4.sif" #Just gonna use native ANTS install cause it's easier.
#module load singularity
scratch="/30days/uqtshaw/"
mkdir -p ${scratch}/STIMMRI/alct/${subjName}
cd ${scratch}/STIMMRI/alct/${subjName}

data_dir="${scratch}/STIMMRI/bids/"
